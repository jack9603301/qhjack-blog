...
module.exports = {
    base: '/qhjack-blog/',//如果你准备发布到 https://<USERNAME>.github.io/<REPO>/ ，也就是说你的仓库地址是 https://github.com/<USERNAME>/<REPO> ，则将 base 设置为 "/<REPO>/"。
    ...
    * */
    themeConfig: {
        ...
        * */
        ...
        //md文件的仓库地址
        docsRepo: 'https://gitee.com/jack960330/qhjack-blog',
        ...
        * */
        ...
        //定制首页随机一言文字
        customRandomValue: '在茫茫之中，探索自然奥秘，在星星之源，绽放声明之花',
        ...
        about: [
            {
                ...
                title: "我?",
                describe: [
                    "我是一名喜欢开源技术的普通人，涉足智能家居，3d打印等，坐标广州"
                ],
                tag: [
                    "coding",
                    "宅男",
        ...
        * */
        ...
        //网站开始时间，请按照以下格式进行
        startRunTime: "5/13/2022 17：51：50",

        //网站运行时间前缀
        prefixRuntime: "起航天空已运行",
        ...
        //侧边栏配置
        //github地址
        githubUrl: "https://gitee.com/jack960330/qhjack-blog",
        ...
        * */
        ...
        //侧边栏一句话描述
        sidebarDesc: '在茫茫之中，探索自然奥秘，在星星之源，绽放声明之花。起航天空，引领你的未来，配棒你的一生！',
