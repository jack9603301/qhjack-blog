...
NexT.motion.middleWares = {
  header: function() {
    ...
    (CONFIG.scheme === 'custom' || CONFIG.scheme === 'Pisces' || CONFIG.scheme === 'Gemini') && pushToSequence('.custom-logo-image');
  ...
  sidebar: function() {
    ...
    if (sidebarTransition && (CONFIG.scheme === 'custom' || CONFIG.scheme === 'Pisces' || CONFIG.scheme === 'Gemini')) {
      return [{
        targets : sidebar,
