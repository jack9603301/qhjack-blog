...
return [
    ...
    'timestamp' => 1731126512,
    'checksum' => 'd078f4925790d103e0f0e8544bbad01b',
    'files' => [
        ...
        'user/themes' => [
            'themes/quark-child' => [
                'file' => 'user/themes/quark-child/blueprints.yaml',
                'modified' => 1729434484
            ],
            'themes/agency' => [
    ...
    'data' => [
        'items' => [
            ...
            'themes.quark-child.production-mode' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.quark-child.production-mode',
                'validation' => 'loose'
            ],
            'themes.quark-child.grid-size' => [
                'type' => 'select',
                ...
                'name' => 'themes.quark-child.grid-size',
                'validation' => 'loose'
            ],
            'themes.quark-child.header_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.quark-child.header_section',
                'validation' => 'loose'
            ],
            'themes.quark-child.custom_logo' => [
                'type' => 'file',
                'label' => 'Custom Logo',
                'size' => 'large',
                ...
                'name' => 'themes.quark-child.custom_logo',
                'validation' => 'loose'
            ],
            'themes.quark-child.custom_logo_mobile' => [
                'type' => 'file',
                ...
                'name' => 'themes.quark-child.custom_logo_mobile',
                'validation' => 'loose'
            ],
            'themes.quark-child.header-fixed' => [
                'type' => 'toggle',
                'label' => 'Fixed header',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.quark-child.header-fixed',
                'validation' => 'loose'
            ],
            'themes.quark-child.header-animated' => [
                'type' => 'toggle',
                'label' => 'Animated',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.quark-child.header-animated',
                'validation' => 'loose'
            ],
            'themes.quark-child.header-dark' => [
                'type' => 'toggle',
                'label' => 'Dark Style',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quark-child.header-dark',
                'validation' => 'loose'
            ],
            'themes.quark-child.header-transparent' => [
                'type' => 'toggle',
                'label' => 'Transparent',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quark-child.header-transparent',
                'validation' => 'loose'
            ],
            'themes.quark-child.footer_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.quark-child.footer_section',
                'validation' => 'loose'
            ],
            'themes.quark-child.sticky-footer' => [
                'type' => 'toggle',
                'label' => 'Sticky footer',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.quark-child.sticky-footer',
                'validation' => 'loose'
            ],
            'themes.quark-child.blog_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.quark-child.blog_section',
                'validation' => 'loose'
            ],
            'themes.quark-child.blog-page' => [
                'type' => 'text',
                'label' => 'Blog Page',
                'size' => 'medium',
                'default' => '/blog',
                'name' => 'themes.quark-child.blog-page',
                'validation' => 'loose'
            ],
            'themes.quark-child.spectre_section' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'themes.quark-child.spectre_section',
                'validation' => 'loose'
            ],
            'themes.quark-child.spectre' => [
                'type' => '_parent',
                'name' => 'themes.quark-child.spectre',
                'form_field' => false
            ],
            'themes.quark-child.spectre.exp' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.quark-child.spectre.exp',
                'validation' => 'loose'
            ],
            'themes.quark-child.spectre.icons' => [
                'type' => 'toggle',
                'label' => 'Icons CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.quark-child.spectre.icons',
                'validation' => 'loose'
            ],
            'themes.agency' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'themes' => [
                'quark-child' => [
                    'production-mode' => 'themes.quark-child.production-mode',
                    'grid-size' => 'themes.quark-child.grid-size',
                    'header_section' => 'themes.quark-child.header_section',
                    'custom_logo' => 'themes.quark-child.custom_logo',
                    'custom_logo_mobile' => 'themes.quark-child.custom_logo_mobile',
                    'header-fixed' => 'themes.quark-child.header-fixed',
                    'header-animated' => 'themes.quark-child.header-animated',
                    'header-dark' => 'themes.quark-child.header-dark',
                    'header-transparent' => 'themes.quark-child.header-transparent',
                    'footer_section' => 'themes.quark-child.footer_section',
                    'sticky-footer' => 'themes.quark-child.sticky-footer',
                    'blog_section' => 'themes.quark-child.blog_section',
                    'blog-page' => 'themes.quark-child.blog-page',
                    'spectre_section' => 'themes.quark-child.spectre_section',
                    'spectre' => [
                        'exp' => 'themes.quark-child.spectre.exp',
                        'icons' => 'themes.quark-child.spectre.icons'
                    ]
                ],
                'agency' => [
                    'dropdown' => [
